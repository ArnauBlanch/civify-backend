...
class IssueTest < ActiveSupport::TestCase
  ...
  def setup
    @user = users(:Lorem)
    @issue = @user.issues.build(name: "sample issue", latitude: 76.4, longitude: 38.2, category: "arbolada",
                       picture: "path", description: "desc", risk: true, solved: true, supports: 23, reports: 23)
  end
